...
public class BenchmarkRunner
{
	...
	public static void main(String args[]) throws InterruptedException, IOException
	{
		...
		//writeResults("FDListRW 100% Reads", rwReadOnly, rawOut, normalizedOut);
	...
	private static void writeNormalizedResults(String testTitle, List<BenchmarkResult> benchmarkResults, BufferedWriter out) throws IOException
	{
		...
		out.write(Long.toString(totalReads/iteration));
		out.write(",");
		out.write(Long.toString(totalWrites/iteration));
		out.write(",");
		out.write(Long.toString(totalDeletes/iteration));
		out.write("\n");
	}
}
